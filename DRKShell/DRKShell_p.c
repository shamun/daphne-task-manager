...
typedef struct _DRKShell_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } DRKShell_MIDL_TYPE_FORMAT_STRING;

typedef struct _DRKShell_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } DRKShell_MIDL_PROC_FORMAT_STRING;

typedef struct _DRKShell_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } DRKShell_MIDL_EXPR_FORMAT_STRING;
...
extern const DRKShell_MIDL_TYPE_FORMAT_STRING DRKShell__MIDL_TypeFormatString;
extern const DRKShell_MIDL_PROC_FORMAT_STRING DRKShell__MIDL_ProcFormatString;
extern const DRKShell_MIDL_EXPR_FORMAT_STRING DRKShell__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IDRKShellMenu_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IDRKShellMenu_ProxyInfo;
...
static const DRKShell_MIDL_PROC_FORMAT_STRING DRKShell__MIDL_ProcFormatString =
    {
        0,
        {
...
static const DRKShell_MIDL_TYPE_FORMAT_STRING DRKShell__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    DRKShell__MIDL_ProcFormatString.Format,
...
/* Object interface: IDRKShellMenu, ver. 0.0,
   GUID={0x8DEF031A,0x4091,0x40D7,{0x9E,0x09,0xC3,0x4F,0xEB,0x0F,0xB8,0x7C}} */

#pragma code_seg(".orpc")
static const unsigned short IDRKShellMenu_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IDRKShellMenu_ProxyInfo =
    {
    &Object_StubDesc,
    DRKShell__MIDL_ProcFormatString.Format,
    &IDRKShellMenu_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IDRKShellMenu_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    DRKShell__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IDRKShellMenuProxyVtbl = 
{
    0,
    &IID_IDRKShellMenu,
    IUnknown_QueryInterface_Proxy,
...
static const PRPC_STUB_FUNCTION IDRKShellMenu_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IDRKShellMenuStubVtbl =
{
    &IID_IDRKShellMenu,
    &IDRKShellMenu_ServerInfo,
    7,
    &IDRKShellMenu_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    DRKShell__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _DRKShell_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IDRKShellMenuProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _DRKShell_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IDRKShellMenuStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _DRKShell_InterfaceNamesList[] = 
{
    "IDRKShellMenu",
    "IComponentRegistrar",
    0
...
const IID *  const _DRKShell_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _DRKShell_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _DRKShell, pIID, n)

int __stdcall _DRKShell_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _DRKShell, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _DRKShell, 2, *pIndex )
    
}

const ExtendedProxyFileInfo DRKShell_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _DRKShell_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _DRKShell_StubVtblList,
    (const PCInterfaceName * ) & _DRKShell_InterfaceNamesList,
    (const IID ** ) & _DRKShell_BaseIIDList,
    & _DRKShell_IID_Lookup, 
    2,
    2,
